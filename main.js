$(document).ready(function () {
    ...
    function addTaskHTML(task){
        ...
        // 🔹 Botão toggle subtarefas só se existirem
    ...
    $(document).on('click','.remove-subtask-btn',function(){ 
        ...
        // 🔹 Se não houver mais subtarefas, remove botão toggle
        if(task.subtasks.length === 0){
    ...
    $(document).on('click','.add-subtask-btn',function(){
        ...
        // 🔹 Mostrar botão toggle se for a primeira subtarefa
    ...
    $(document).on('click', '.toggle-subtasks-btn', function() {
        ...
        // Alterna a classe 'collapsed' para rotacionar a setinha
